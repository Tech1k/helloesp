        ...
        <div class='HMP'>
            ...
            <blockquote class='box'>
                <p class='lead'>
                    ...
                    I am currently working on adding chip stats such as uptime and cpu usage and more! Checkout the <a href='https://github.com/Tech1k/helloesp' target='_blank'>GitHub repo</a> for the code!
                </p>
            </blockquote>
